...
function sendLaaToClient(ipv6, ws) {
    var event = {
        type: "sp_ipv6",
        data: {
            ipv6: ipv6,
...
function sendLastPackageToClient(LastPackageSent, ws) {
...
exports.sendLastPackageToClient = sendLastPackageToClient;
