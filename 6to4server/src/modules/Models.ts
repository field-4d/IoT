...
export const PackageToSend = (
  ...
  if (pkg.ztp_315_surface_temperature !== undefined) {
    readyPoint
      .floatField('ztp_315_surface_temperature', pkg.ztp_315_surface_temperature)
  ...
  if (pkg.iis3dhhc_x_acceleration !== undefined) {
    readyPoint
      .floatField('iis3dhhc_x_acceleration', pkg.iis3dhhc_x_acceleration)
      .floatField('iis3dhhc_y_acceleration', pkg.iis3dhhc_y_acceleration)
      .floatField('iis3dhhc_z_acceleration', pkg.iis3dhhc_z_acceleration)
      .floatField('iis3dhhc_temperature', pkg.iis3dhhc_temperature)
...
export const Package = (obj: any) => {
  ...
  else if (obj.ztp_315_surface_temperature !== undefined) {
