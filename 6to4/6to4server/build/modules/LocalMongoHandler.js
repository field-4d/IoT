...
//   const bsonData = {
//     UniqueID: `exp_${additionalExperimentData.ExperimentData.Exp_id}_${additionalExperimentData.ExperimentData.Exp_name}_${additionalExperimentData.SensorData.LLA}_${new Date(timeStamp * 1000).toISOString()}_${pkg.ipv6}`,
//     Owner: Device_Owner,
//     MetaData: {
...
// }
// // PackageToSendMongo - for new package types
// export async function PackageToSendMongo(pkg: PackageObj, timeStamp: number, buffer: number, exp_name: string) {
//   const db = await dbPromise;
//   const experimentCollection = db.collection(exp_name);
//   // Fetch additional experiment data from the other MongoDB collection
...
//     throw new Error(`Experiment data not found for experiment ${exp_name}`);
//   }
//   // Check if the location contains the word "faulty" and, if so, skip the sensor
//   if (additionalExperimentData.SensorData.Location.includes("faulty")) {
//     console.log("Skipping upload due to faulty location:", additionalExperimentData.SensorData.Location);
//     return;
//   }
...
//   let version = "V2.5"; // Default version
//   // Determine the version based on the package type
//   if (pkg.light !== undefined) {
//     version = "V2.5";
//   } else if (pkg.bmp_390_u18_pressure !== undefined || pkg.co2_ppm !== undefined || pkg.air_velocity !== undefined) {
//     version = "V2.5";
//   }
//   // Construct BSON object based on pkg and additionalExperimentData
//   const bsonData: any = {
...
//       Location: additionalExperimentData.SensorData.Location,
//       Coordinates: additionalExperimentData.SensorData.coordinates,
//       Version: version // Set the version dynamically
//     },
//     ExperimentData: {
//       MAC_address: mac_add,
//       Exp_id: additionalExperimentData.ExperimentData.Exp_id,
...
//       Labels: additionalExperimentData.SensorData.Label,
//       LabelOptions: additionalExperimentData.SensorData.LabelOptions,
//       light: null, // Initialize all fields with null or default values
//       barometric_pressure: null,
//       barometric_temp: null,
//       temperature: null,
//       humidity: null,
//       tmp107_amb: null,
//       tmp107_obj: null,
...
//       batmon_battery_voltage: pkg.batmon_battery_voltage || pkg.battery || null, // Ensure 'batmon_battery_voltage' or 'battery' is always included
//       co2_ppm: null,
//       air_velocity: null
//     }
//   };
//   // Populate fields based on the package type
//   if (pkg.light !== undefined) {
//     bsonData.SensorData.light = pkg.light;
//     bsonData.SensorData.barometric_pressure = pkg.bmp_press;
//     bsonData.SensorData.barometric_temp = pkg.bmp_temp;
//     bsonData.SensorData.temperature = pkg.hdc_temp;
//     bsonData.SensorData.humidity = pkg.hdc_humidity;
//     if (pkg.tmp107_amb !== undefined) bsonData.SensorData.tmp107_amb = pkg.tmp107_amb;
//     if (pkg.tmp107_obj !== undefined) bsonData.SensorData.tmp107_obj = pkg.tmp107_obj;
//   } else if (pkg.bmp_390_u18_pressure !== undefined) {
//     bsonData.SensorData.bmp_390_u18_pressure = pkg.bmp_390_u18_pressure;
//     bsonData.SensorData.bmp_390_u18_temperature = pkg.bmp_390_u18_temperature;
//     bsonData.SensorData.bmp_390_u19_pressure = pkg.bmp_390_u19_pressure;
//     bsonData.SensorData.bmp_390_u19_temperature = pkg.bmp_390_u19_temperature;
//     bsonData.SensorData.hdc_2010_u13_temperature = pkg.hdc_2010_u13_temperature;
//     bsonData.SensorData.hdc_2010_u13_humidity = pkg.hdc_2010_u13_humidity;
//     bsonData.SensorData.hdc_2010_u16_temperature = pkg.hdc_2010_u16_temperature;
//     bsonData.SensorData.hdc_2010_u16_humidity = pkg.hdc_2010_u16_humidity;
//     bsonData.SensorData.hdc_2010_u17_temperature = pkg.hdc_2010_u17_temperature;
//     bsonData.SensorData.hdc_2010_u17_humidity = pkg.hdc_2010_u17_humidity;
//     bsonData.SensorData.opt_3001_u1_light_intensity = pkg.opt_3001_u1_light_intensity;
//     bsonData.SensorData.opt_3001_u2_light_intensity = pkg.opt_3001_u2_light_intensity;
//     bsonData.SensorData.opt_3001_u3_light_intensity = pkg.opt_3001_u3_light_intensity;
//     bsonData.SensorData.opt_3001_u4_light_intensity = pkg.opt_3001_u4_light_intensity;
//     bsonData.SensorData.opt_3001_u5_light_intensity = pkg.opt_3001_u5_light_intensity;
//     bsonData.SensorData.batmon_temperature = pkg.batmon_temperature;
//     bsonData.SensorData.batmon_battery_voltage = pkg.batmon_battery_voltage;
//   } else if (pkg.co2_ppm !== undefined || pkg.air_velocity !== undefined) {
//     bsonData.SensorData.co2_ppm = pkg.co2_ppm;
//     bsonData.SensorData.air_velocity = pkg.air_velocity;
//   }
//   // Insert data into the target collection
//   await targetCollection.insertOne(bsonData);
//   console.log("The bson which is inserted is:", bsonData);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_3) {
            switch (_3.label) {
                ...
                case 2:
                    additionalExperimentData = _3.sent();
                    // Check if the additional data is found and not empty
                    if (!additionalExperimentData) {
